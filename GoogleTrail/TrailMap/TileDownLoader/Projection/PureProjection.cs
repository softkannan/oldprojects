...
namespace TileDownLoader.Projection
{
    ...
    public abstract class PureProjection
    {
        ...
        /// <param name="zoom"></param>
        /// <returns></returns>
        public abstract Location FromPixelToLatLng(int x, int y, int zoom);
        ...
        /// <param name="zoom"></param>
        /// <returns></returns>
        public Point FromLatLngToPixel(Location p, int zoom)
        {
        ...
        /// <param name="zoom"></param>
        /// <returns></returns>
        public Location FromPixelToLatLng(Point p, int zoom)
        {
        ...
        /// </summary>
        public List<Point> GetAreaTileList(LocationRect rect, int zoom, int padding)
        {
            List<Point> ret = new List<Point>();

            Point topLeft = FromPixelToTileXY(FromLatLngToPixel(rect.Northwest, zoom));
            Point rightBottom = FromPixelToTileXY(FromLatLngToPixel(rect.South, rect.East, zoom));
